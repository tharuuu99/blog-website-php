    ...
    <header class="bg-white p-4 shadow-md">
        ...
        <nav class="navbar flex justify-between items-center mt-4">
            ...
            <div class="user flex space-x-4">
                <div class="Login">
                    <a href="User/login/login.php" class="text-gray-800 hover:text-blue-500">Login</a>
                </div>
                <div class="signup">
                    <a href="User/signup/signup.php" class="text-gray-800 hover:text-blue-500">Signup</a>
                </div>
            </div>
        </nav>
    </header>
